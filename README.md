...
The installation script is designed for a [Xorg Siduction](https://siduction.org/installation-media/) based on debian sid.
[SDDM](https://wiki.archlinux.org/title/SDDM), [GRUB](https://wiki.archlinux.org/title/GRUB), etc. and is at your own risk.
